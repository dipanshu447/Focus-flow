      ...
      <main className="w-full max-w-3xl px-6 py-16 md:py-30">
        ...
        <motion.article 
          ...
          <section className="flex flex-col gap-6">
            <h2 className="text-2xl font-light tracking-wide text-white/90">Acceptance of Terms</h2>
          ...
          <section className="flex flex-col gap-6">
            <h2 className="text-2xl font-light tracking-wide text-white/90">User Accounts</h2>
            <p className="text-white/60 font-light leading-relaxed">
          ...
          <section className="flex flex-col gap-6">
            <h2 className="text-2xl font-light tracking-wide text-white/90">Acceptable Use</h2>
            <div className="flex flex-col gap-4 text-white/60 font-light leading-relaxed">
              ...
              <ul className="list-disc pl-5 flex flex-col gap-2 text-white/70">
          ...
          <section className="flex flex-col gap-6">
            <h2 className="text-2xl font-light tracking-wide text-white/90">User Content & Data</h2>
            <p className="text-white/60 font-light leading-relaxed">
          ...
          <section className="flex flex-col gap-6">
            <h2 className="text-2xl font-light tracking-wide text-white/90">Intellectual Property</h2>
            <p className="text-white/60 font-light leading-relaxed">
          ...
          <section className="flex flex-col gap-6">
            <h2 className="text-2xl font-light tracking-wide text-white/90">Service Availability</h2>
            <p className="text-white/60 font-light leading-relaxed">
          ...
          <section className="flex flex-col gap-6">
            <h2 className="text-2xl font-light tracking-wide text-white/90">Limitation of Liability</h2>
            <p className="text-white/60 font-light leading-relaxed">
          ...
          <section className="flex flex-col gap-6">
            <h2 className="text-2xl font-light tracking-wide text-white/90">Changes to These Terms</h2>
            <p className="text-white/60 font-light leading-relaxed">
