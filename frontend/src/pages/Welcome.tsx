...
export default function Welcome() {
    return (
        <div
            className="relative z-2 py-25 flex flex-col bg-top bg-no-repeat grayscale"
            style={{ backgroundImage: `url(${heroBg})` }}
        >
            <div className='absolute inset-0 dark:bg-black/70 z-1 bg-white/70'></div>
            <div className='absolute inset-0 bg-linear-to-b from-transparent to-black z-1 '></div>
            <div className="w-3xl mt-10 text-center dark:text-white flex flex-col items-center gap-1 self-center relative z-10">
                <small className="px-4 py-1.5 bg-neutral-200/70 dark:bg-neutral-900 dark:border-neutral-800 dark:text-neutral-400 border border-gray-300 rounded-full text-sm italic font-[Indie_Flower] tracking-wide text-neutral-600">For people who actually finish things</small>
                <h1 className="text-8xl font-black my-3 tracking-tight">Stop Switching. Start Finishing.</h1>
                <p>One task. One session. One outcome.</p>
                <div className="flex gap-5 mt-4">
                    <button className="mt-5 bg-black text-white hover:shadow-white dark:bg-neutral-200 dark:text-black dark:hover:-translate-y-1 dark:hover:bg-white transition-all duration-200 font-medium px-7 py-3 rounded-full text-sm cursor-pointer scroll-smooth">Start Free</button>
                    <button className="mt-5 border border-black dark:border-neutral-200 hover:text-white dark:text-white dark:hover:font-bold dark:hover:border-white text-black dark:hover: transition-all duration-200 shadow-sm hover:shadow-md font-medium px-6 py-3 rounded-full text-sm scroll-smooth cursor-pointer" onClick={e => scrollTosection(e, 'howitworks')}>See it in action →</button>
                </div>
            </div>
            <div className="mt-25 mx-20 flex text-white relative z-10">
            ...
            <div className="mx-20 mt-30 flex flex-col relative z-10">
                ...
                <div className='flex justify-between gap-20 mt-20'>
                    <div className='relative dark:hover:bg-gray-950 hover:-translate-y-2 border dark:border-gray-800 hover:border-gray-700 p-5 rounded-3xl ease transition-all duration-200'>
            ...
            <div className="mt-25 mx-20 flex flex-col text-white relative z-10 items-center text-center">
                <small className="px-4 py-2 bg-neutral-200/70 dark:bg-neutral-900 dark:border-neutral-800 dark:text-neutral-300 border border-gray-300 rounded-full text-sm italic font-[Indie_Flower] tracking-wide text-neutral-600 dark:hover:bg-neutral-900 hover:-translate-y-1 hover:border-gray-700 p-5 ease transition-all duration-200">See it in action</small>
                ...
                <div className='w-5xl bg-[radial-gradient(circle,rgba(255,255,255,0.08),transparent)] mt-15 overflow-hidden rounded-2xl border border-neutral-300 dark:border-neutral-500 shadow-sm hover:shadow-md dark:shadow-[0_30px_80px_rgba(255,255,0,0.2)] transition-all duration-300'>
            ...
            <div className="mt-25 mx-20 flex flex-col text-white relative z-10">
            ...
            <div className="relative my-20 text-center dark:text-white py-40 flex flex-col items-center z-10">
                <div
                    className="absolute inset-0 bg-cover bg-center mask-[linear-gradient(to_bottom,transparent_0%,black_20%,black_80%,transparent_100%)] grayscale -z-10 opacity-40"
