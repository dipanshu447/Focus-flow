    ...
    return (
        <div className="transition-all duration-300 ease-in-out fixed gap-4 m-auto z-10 py-1.5 px-6 top-6 rounded-full flex justify-center items-center bg-white/60 backdrop-blur-md dark:bg-neutral-900/60 shadow-lg shadow-black/5 border border-gray-200 dark:border-neutral-800">
            ...
            <div className="flex text-gray-700 dark:text-gray-300 text-sm font-medium gap-1">
                <Link to='guide' className="px-4 py-2 transition-all duration-300 ease-in-out hover:text-black dark:hover:text-white hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded-2xl cursor-pointer">Guide</Link>
                ...
                <Link to='contact' className="px-4 py-2 transition-all duration-300 ease-in-out hover:text-black dark:hover:text-white hover:bg-neutral-200 dark:hover:bg-neutral-800 rounded-2xl cursor-pointer">Contact</Link>
            </div>
            {token ? (
                <Link to='app' className="bg-black text-white hover:bg-neutral-800 dark:bg-white dark:text-black dark:hover:bg-neutral-200 transition-all duration-200 shadow-sm hover:shadow-md font-medium px-6 py-1.5 rounded-full text-sm">Launch App</Link>
            ) : (
